...
CREATE TABLE IF NOT EXISTS `mydb`.`client` (
  ...
  `client_address` VARCHAR(120) NULL,
  `client_nationality` VARCHAR(1) NULL,
  `client_id_number` VARCHAR(10) NULL,
  `client_phone` VARCHAR(11) NULL,
