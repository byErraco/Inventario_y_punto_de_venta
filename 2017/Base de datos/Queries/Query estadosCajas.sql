SELECT descripcion_caja, p.tipo_persona||'-'||p.numero_identificacion_persona as empleado_apertura, fecha_apertura, p1.tipo_persona||'-'||p1.numero_identificacion_persona as empleado_cierre, fecha_corte as fecha_cierre
